      ...
      await Promise.all(
        vaultIds.map(async (uid) => {
          ...
          const vault: TVault = {
            ...
            contributeStart: Number(values[2] as bigint),
            contributeEnd: Number(values[3] as bigint),
            ...
            fixedAmount: Number(values[9] as bigint),
            percentage: Number(values[10] as bigint),
